...
<script type="text/javascript">
    ...
    var url_search = "http://api.themoviedb.org/3/search/" + "<?php echo $_GET['channel'] ?>" + "?api_key=7de963c0814074012087ebfaa507388b&query=" + "<?php echo $_GET['search'] ?>";
        ...
        ({
            ...
            success: function (response) {
                ...
                for (i = 0; i < film.length; i++) {
                    ...
                    if ("<?php echo $_GET['channel'] ?>" == "movie") {
                        isi_html += "<a href='../details/controler.php?id=" + film[i].id + "'>";
                    } else {
                        isi_html += "<a href='../details/controlertv.php?id=" + film[i].id + "'>";
                    }

                    isi_html += "<div class='card'>";
                    isi_html += "<img class = 'poster' src='http://image.tmdb.org/t/p/w342///" + film[i].poster_path + "' height='550px'>";
                    isi_html += "<div class='description'>";

                    if ("<?php echo $_GET['channel'] ?>" == "movie") {
                        isi_html += "<p class ='title'>" + film[i].title + "</p>";
                    } else {
                        isi_html += "<p class ='title'>" + film[i].original_name + "</p>";
                    }
